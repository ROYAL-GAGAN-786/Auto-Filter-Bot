...
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/5062c6e34cd956c9b6ed4-0f8819246a87befd68.jpg')
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

#this vars is for when heroku or koyeb acc get banned, then change this vars as your file to link bot name
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002441889883'))
URL = environ.get('URL', '')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002578060057')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002578060057'))
